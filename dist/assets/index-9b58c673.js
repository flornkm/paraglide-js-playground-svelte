...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      if (dirty & /*_languageTag*/
      1 && safe_not_equal(previous_key, previous_key = /*_languageTag*/
      ctx2[0])) {
        group_outros();
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  onSetLanguageTag((newLanguageTag) => {
    $$invalidate(0, _languageTag = newLanguageTag);
  });
  $$self.$$set = ($$props2) => {
    if ("$$scope" in $$props2)
      $$invalidate(1, $$scope = $$props2.$$scope);
  };
  $$invalidate(0, _languageTag = languageTag);
  return [_languageTag, $$scope, slots];
}
class ParaglideJsProvider extends SvelteComponent {
  constructor(options) {
    super();
...
function create_default_slot(ctx) {
  ...
  return {
    c() {
      p0 = element("p");
      p0.textContent = `${greeting({ name: "Samuel", count: 5 })}`;
      t1 = space();
      p1 = element("p");
      p1.textContent = `${currentLanguageTag({ languageTag })}`;
      t3 = space();
      button0 = element("button");
      button0.textContent = 'change language to "de"';
      t5 = space();
      button1 = element("button");
      button1.textContent = 'change language to "en"';
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  let paraglidesvelte;
  let current;
  paraglidesvelte = new ParaglideJsProvider({
    props: {
  ...
  return {
    c() {
      create_component(paraglidesvelte.$$.fragment);
    },
    m(target, anchor) {
      mount_component(paraglidesvelte, target, anchor);
      current = true;
    },
    p(ctx2, [dirty]) {
      const paraglidesvelte_changes = {};
      if (dirty & /*$$scope*/
      4) {
        paraglidesvelte_changes.$$scope = { dirty, ctx: ctx2 };
      }
      paraglidesvelte.$set(paraglidesvelte_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(paraglidesvelte.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(paraglidesvelte.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      destroy_component(paraglidesvelte, detaching);
    }
  };
}
